        ...
        public static string GetInfo(string agentid)
        {
            ...
            try
            {
                ...
                if (objEngagementResult != null)
                {
                    ...
                    sb.Append("<div style='font-size: 20px; padding-bottom:10px'> You have <span id='divFreeMin'>" + objEngagementResult.FreeMinutes.ToString() + "</span> free minutes left. What you would like to do?</div>");
